...
const Footer = () => {
    return(
        <footer className={styles.flex_container}>
            <div className={styles.text}>Copyright © Saab</div>
            <div className={styles.social_networks}>
                <a target={"_blank"} href="https://www.instagram.com/sotsialov_alimzhan/" rel="noreferrer">
                    <svg className={styles.social_link} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50"
                         viewBox="0 0 50 50">
                        <path
